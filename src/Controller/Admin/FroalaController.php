...
#[Route(path: '/admin/froala')]
class FroalaController extends AbstractController
{
    #[Route(path: '/envoi-image', name: 'froala_upload_file')]
    ...
    #[Route(path: '/suppression-image', name: 'froala_remove_file')]
    ...
    #[Route(path: '/liste-images', name: 'froala_lib_files')]
    ...
    #[Route(path: '/envoi-video', name: 'froala_upload_video')]
